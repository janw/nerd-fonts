...
* [Nerd Fonts Complete (ancho doble)](https://aur.archlinux.org/packages/nerd-fonts-complete/)
* [Nerd Fonts Complete (ancho simple)](https://aur.archlinux.org/packages/nerd-fonts-complete-mono-glyphs/)
